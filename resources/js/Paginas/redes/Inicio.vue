  ...
  const {
    ...
    const obtenerDatos = async(id) => {
        ...
        if(red.value)
        {
            ...
            form.value.nombre=red.value.nombre
        }
    }
    const editar = (id) => {
        limpiar();
        ...
        document.getElementById("modalredLabel").innerHTML = 'Editar Red';
        openModal('#modalred')
    }
    const nuevo = () => {
        limpiar()
        ...
        openModal('#modalred')
        document.getElementById("modalredLabel").innerHTML = 'Nueva Red';
                            ...
                            <table class="table table-bordered table-hover table-sm table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="(red,index) in redes.data" :key="red.id">
                                        <td class="text-center">{{ index + redes.from }}</td>
                                        <td>{{ red.nombre }}</td>
                                        <td>
                                            <button class="btn btn-warning btn-sm" title="Editar Red" @click.prevent="editar(red.id)">
                                                <i class="fas fa-edit"></i>
                                            </button>&nbsp;
                                            <button class="btn btn-danger btn-sm" title="Eliminar Red" @click.prevent="eliminar(red.id)">
