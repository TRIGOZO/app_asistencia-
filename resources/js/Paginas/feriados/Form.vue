...
const crud = {
    'nuevo': async() => {
        await agregarFeriado(form.value)
        form.value.errors = []
        if(errors.value)
        {
    ...
    'editar': async() => {
        await actualizarFeriado(form.value)
        form.value.errors = []
        if(errors.value)
        {
            form.value.errors = errors.value
...
<template>
    ...
    <div class="modal fade" id="modalferiado" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="modalferiadoLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalferiadoLabel">Modal title</h1>
