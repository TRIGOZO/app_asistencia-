                        ...
                        <div class="table-responsive">         
                            <table class="table table-bordered table-hover table-sm table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="(rol,index) in roles.data" :key="rol.id">
                                        <td class="text-center">{{ index + roles.from }}</td>
                                        <td>{{ rol.nombre }}</td>
                                        <td>
                                            <button class="btn btn-warning btn-sm" title="Editar Rol" @click.prevent="editar(rol.id)">
                                                <i class="fas fa-edit"></i>
                                            </button>&nbsp;
                                            <button class="btn btn-danger btn-sm" title="Eliminar Rol" @click.prevent="eliminar(rol.id)">
