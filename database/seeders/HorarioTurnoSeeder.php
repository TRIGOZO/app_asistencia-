...
class HorarioTurnoSeeder extends Seeder
{
    ...
    $registros = [
        ...
        [
            'tipo_turno_id' => TipoTurno::where('nombre','MAÑANA Y TARDE')->value('id'),//mañana de turno mañana y tarde
            'horaentrada'   => '08:00',
            'horasalida'   => '13:00',
            'toleranciaantes'   => 5,
            'toleranciadespues' => 5,
        ...
        [
            'tipo_turno_id' => TipoTurno::where('nombre','MAÑANA Y TARDE')->value('id'),//tarde de turno mañana y tarde
