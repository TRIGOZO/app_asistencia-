<script setup>
  ...
  import EstablecimientoForm from './Form.vue'
  ...
  const {
    ...
    const editar = (id) => {
        ...
        document.getElementById("modalestablecimientoLabel").innerHTML = 'Editar Establecimiento';
    ...
    const nuevo = () => {
        ...
        openModal('#modalestablecimiento')
        document.getElementById("modalestablecimientoLabel").innerHTML = 'Nuevo Establecimiento';
...
<template>
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="(establecimiento,index) in establecimientos.data" :key="establecimiento.id">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger btn-sm" title="Eliminar Establecimiento" @click.prevent="eliminar(establecimiento.id)">
    ...
    <EstablecimientoForm :form="form" @onListar="listarEstablecimientos" :currentPage="establecimientos.current_page"></EstablecimientoForm>
</template>
